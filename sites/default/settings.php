...
/**
 * Provide configuration for the master module.
 *
 * IMPORTANT: This file must be included from sites/default/settings.php.
 */

// Specify the master module version.
$conf['master_version'] = 2;

// Include modules that should be enabled in each scope.
// - base: Should be enabled in all environments.
// - local: Should only be enabled in local development environments.
// - remote: Should only be enabled in remote deployment environments.
...
// Include modules that should not be uninstalled in each scope (see comment for
// master_modules above for information about each scope).
...
// Include path patterns for modules that should not be removed. By default all
// core modules are specified.
$conf['master_removable_blacklist'] = array('modules/*');
